...
<head>
    ...
    <meta name="title" content="BDCODA | Dashboard" />
    <meta name="author" content="BDCODA" />
    <meta name="description" content="BDCODA" />
                                            ...
                                            <div class="direct-chat-messages">
                                                ...
                                                <div class="direct-chat-msg">
                                                    ...
                                                    <img class="direct-chat-img"
                                                        src="{{ asset('backend') }}/assets/img/user1-128x128.jpg"
                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('backend') }}/assets/img/user7-128x128.jpg"
                                                                alt="User Avatar" />
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Sarah Doe
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('backend') }}/assets/img/user5-128x128.jpg"
                                                                alt="User Avatar" />
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Nora S. Vans
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('backend') }}/assets/img/user6-128x128.jpg"
                                                                alt="User Avatar" />
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    John K.
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="{{ asset('backend') }}/assets/img/user8-128x128.jpg"
                                                                alt="User Avatar" />
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Kenneth M.
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="row text-center m-1">
                                                ...
                                                <div class="col-3 p-2">
                                                    <img class="img-fluid rounded-circle"
                                                        src="{{ asset('backend') }}/assets/img/user4-128x128.jpg"
                                                        alt="User Image" />
                                                    <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                        href="#">
                                                        Nora
